                    ...
                    <section>
                        <div className="space-y-14">
                            <div className="w-full">
                                ...
                                <h1 className="mt-3 font-light text-2xl lg:text-[32px] text-primary-dark">
                                    {product.name}
                                </h1>
                                <span className="mt-1 text-lg lg:text-xl font-semibold text-black">
                                    {formatCurrency(product.price_in_cents, TypeCurrency.AOA)}
                                </span>
